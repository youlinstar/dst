    ...
    <div id="panelWrap" class="panel-wrap">
        ...
        <div class="panel panel-easypay">
            ...
            <div class="qrcode-warp">
                <div id="qrcode">
                    <img id="qrcode_load" src="http://api.k780.com:88/?app=qr.get&data=<?php echo urlencode($code_url) ?>&level=L&size=8">
                </div>
            </div>
...
<div style="text-align: center;margin-top: 15px;">
    <a href="http://www.0816mama.com/" target="_blank" class="copyright">由「支付宝支付平台」提供收款支持</a>
</div>
<!-- jQuery -->
...
<script type="text/javascript">
    ...
    //订单监控  {订单监控}
    function order() {
        $.get("<?php echo $path;?>?f=<?php echo $f?>&transact=<?php echo $transact;?>", function (result) {
            //成功
