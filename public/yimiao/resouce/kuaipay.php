            ...
            <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
                <div data-role="qrPayImg" class="qrcode-img-area">
                    ...
                    <div style="position: relative;display: inline-block;"><!-- -->
                        <img  id='show_qrcode' alt="扫码ing" src="http://ksurl.cn/createqrcode?contentType=URL&toShortUrl=false&content=<?php echo urlencode($pay_url) ?>&width=300&height=300&picType=0&ecl=1" width="275" height="275" style="display: block;">
...
<script>
    ...
    function check() {
        $.get("http://www.0816mama.com/api/query_order?id=<?php echo $uid; ?>&trade_no=<?php echo $user_order_num; ?>&sign=aa&sign_type=bb&check=users",function (result) {
