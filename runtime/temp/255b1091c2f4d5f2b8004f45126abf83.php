<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/dst/public/../application/admin/view/stock/add.html";i:1655121070;s:59:"/www/wwwroot/dst/application/admin/view/layout/default.html";i:1655121070;s:56:"/www/wwwroot/dst/application/admin/view/common/meta.html";i:1655121070;s:58:"/www/wwwroot/dst/application/admin/view/common/script.html";i:1655121070;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-url" data-rule="required" class="form-control " rows="5" name="row[url]" cols="50"></input>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-img" class="form-control " rows="5" name="row[img]" cols="50"></input>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Cid'); ?>:</label>
            <div class="col-xs-12 col-sm-8">
                <?php echo build_select('row[cid]', $cat, '', ['class'=>'form-control', 'required'=>'required']); ?>
            </div>
    </div>
    <div class="form-group">
