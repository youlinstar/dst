<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/www/wwwroot/dst/public/../application/admin/view/general/config/index.html";i:1655121070;s:59:"/www/wwwroot/dst/application/admin/view/layout/default.html";i:1655121070;s:56:"/www/wwwroot/dst/application/admin/view/common/meta.html";i:1655121070;s:58:"/www/wwwroot/dst/application/admin/view/common/script.html";i:1655121070;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="panel-body">
        <div id="myTabContent" class="tab-content">
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-8 col-xs-12">
                                            ...
                                            <select <?php echo $item['extend']; ?> name="row[<?php echo $item['name']; ?>]<?php echo $item['type']=='selects'?'[]':''; ?>" class="form-control " data-tip="<?php echo $item['tip']; ?>" <?php echo $item['type']=='selects'?'multiple':''; ?>>
            ...
            <div class="tab-pane fade" id="addcfg">
                <form id="add-form" class="form-horizontal layui-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.config/add'); ?>">
                    <?php echo token(); ?>
