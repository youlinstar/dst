<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"/www/wwwroot/dst/public/../application/admin/view/index/index.html";i:1655121070;s:56:"/www/wwwroot/dst/application/admin/view/common/meta.html";i:1655121070;s:58:"/www/wwwroot/dst/application/admin/view/common/header.html";i:1655121070;s:56:"/www/wwwroot/dst/application/admin/view/common/menu.html";i:1655121070;s:59:"/www/wwwroot/dst/application/admin/view/common/control.html";i:1655121070;s:58:"/www/wwwroot/dst/application/admin/view/common/script.html";i:1655121070;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <body class="hold-transition skin-white-light sidebar-mini fixed <?php if(\think\Config::get('fastadmin.multiplenav')): ?>multiplenav<?php endif; ?>" id="tabs">
        <div class="wrapper">

            <!-- 头部区域 -->
            <header id="header" class="main-header">
                <!-- Logo -->
<a href="javascript:;" class="logo" style="height:60px;">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php echo htmlentities(mb_strtoupper(mb_substr($site['name'],0,6,'utf-8'),'utf-8')); ?></span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b><?php echo htmlentities(mb_substr($site['name'],0,6,'utf-8')); ?></b></span>
</a>
               ...
               <!-- <li>
                ...
                <li>
                    ...
                    <ul class="dropdown-menu wipecache">
                        ...
                        <li><a href="javascript:;" data-type="fwl"><i class="fa fa-rocket"></i> 一键清空访问量</a></li>
                        
                        <li><a href="javascript:;" data-type="log"><i class="fa fa-rocket"></i> 一键清空操作记录</a></li>
...
<section class="sidebar">
    ...
    <!--<div class="user-panel hidden-xs">
        ...
        <div class="pull-left info">
         ...
         &lt;!&ndash;   <a href="general/profile" class="addtabsit"><i class="fa fa-circle text-success"></i> <?php echo __('Online'); ?></a>&ndash;&gt;
            <a href="general/profile" class="addtabsit btn-xs btn btn-success" title="<?php echo __('Online'); ?>"> <?php echo __('Online'); ?></a>
        </div>
    </div>-->
