...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        try {
            ...
            )
            {
                ...
                if($sign != $sigh['sign'])
                {
                    exit("兄弟你想干嘛?替换文件是不行的.....QQ:1714058149");
                }
            }
        ...
        {
            exit("兄弟你想干嘛?替换文件是不行的.....QQ:1714058149".$e->getMessage());
        }
     ...
     * @return array
     */
    protected function buildparams($searchfields = null, $relationSearch = null , $dataLimit = false)
    {
