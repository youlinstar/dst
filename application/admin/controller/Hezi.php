 ...
 * @icon fa fa-circle-o
 */
class Hezi extends Backend
{

    /**
     * Hezi模型对象
     * @var \app\admin\model\Hezi
     */
    ...
    public function index()
    {
        ...
        $this->assign('url' , urldecode($this->getPushUrl()));
    ...
    protected function getPushUrl()
    {
        ...
        if ($fangfeng_url)
        {
            $url = $fangfeng_url . urlencode('/index/index/index?f=' . id_encode($uid));
        }
        else
        {
            $domain = getDomain(1);
            ...
            if ($domain)
            {
                ...
                $hezi_url = $domain .urlencode('/index/index/index?f=' . id_encode($uid));
