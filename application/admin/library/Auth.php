...
class Auth extends \fast\Auth
{
    ...
    public function getSidebar($params = [], $fixedPage = 'dashboard')
    {
        ...
        foreach ($ruleList as $k => &$v) {
            ...
            $v['icon'] = $v['icon'] . '';
            if(strpos($v['icon'],'fa') !== false){
                $v['icon'] = "/assets/img/ico/qqq.png";
            }
                $v['url'] = '/' . $module . '/' . $v['name'];
        ...
        if (Config::get('fastadmin.multiplenav')) {
            ...
            $menu = Tree::instance()->getTreeMenu(
                0,
                '<li class="@class"><a  href="@url@addtabs" addtabs="@id" url="@url" py="@py" pinyin="@pinyin"><img class="menu-img" src="@icon"> <span>@title</span> <span class="pull-right-container">@caret @badge</span></a> @childlist</li>',
                $select_id,
                '',
                'ul',
                'class="treeview-menu"'
            ...
            if ($selected) {
                $nav .= '<li role="presentation" id="tab_' . $selected['id'] . '" class="' . ($referer ? '' : 'active') . '"><a href="#con_' . $selected['id'] . '" node-id="' . $selected['id'] . '" aria-controls="' . $selected['id'] . '" role="tab" data-toggle="tab"><img class="menu-img" src="' . $selected['icon'] . ' "></i> <span>' . $selected['title'] . '</span> </a></li>';
            }
            if ($referer) {
                $nav .= '<li role="presentation" id="tab_' . $referer['id'] . '" class="active"><a href="#con_' . $referer['id'] . '" node-id="' . $referer['id'] . '" aria-controls="' . $referer['id'] . '" role="tab" data-toggle="tab"><img class="menu-img" src="' . $referer['icon'] . '"></i> <span>' . $referer['title'] . '</span> </a> <i class="close-tab fa fa-remove"></i></li>';
            }
        }
